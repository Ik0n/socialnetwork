        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" files="true" role="form" method="POST" action="{{ route('register') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('third_name') ? ' has-error' : '' }}">
                            <label for="third_name" class="col-md-4 control-label">Third name</label>
                            <div class="col-md-6">
                                <input id="third_name" type="text" class="form-control" name="third_name" value="{{ old('third_name') }}" required>
                        ...
                        <!--<div class="form-group">
                            <label for="filename" class="col-md-4 control-label">Avatar</label>
